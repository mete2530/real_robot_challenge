...
class LocalizationNode():
    def __init__(self):
        ...
        self.marker_pub = rospy.Publisher('/gaussian_marker', PoseWithCovarianceStamped, queue_size=10)
    ...
    def publish_pose(self):
        ...
        msg.pose.covariance[0] = self.kf.sigma[0, 0]
        msg.pose.covariance[1] = self.kf.sigma[0, 1]
        msg.pose.covariance[5] = self.kf.sigma[0, 2]
        msg.pose.covariance[6] = self.kf.sigma[1, 0]
        msg.pose.covariance[7] = self.kf.sigma[1, 1]
        msg.pose.covariance[11] = self.kf.sigma[1, 2]
        msg.pose.covariance[30] = self.kf.sigma[2, 0]
        msg.pose.covariance[31] = self.kf.sigma[2, 1]
        msg.pose.covariance[35] = self.kf.sigma[2, 2]
